...
set shiftwidth=2         " pressing >> or << in normal mode indents by 2 characters
set tabstop=2            " a tab character indents to the 2th (or 4th, 8th, etc.) column
set viminfo='20,\"50     " read/write a .viminfo file, don't store more than 50 lines of registers
set encoding=utf8        " non-ascii characters are encoded with UTF-8 by default
set expandtab            " pressing the tab key creates spaces based on 'tabstop' and 'shiftwidth'
...
"   $ ls /home/shay/a/ece264/19sp/vimfiles/{bundle,colors}
"
...
if filereadable('/home/shay/a/ece264/19sp/vimfiles/autoload/pathogen.vim')
	let &runtimepath='/home/shay/a/ece264/19sp/vimfiles,' . &runtimepath
	execute pathogen#infect('/home/shay/a/ece264/19sp/vimfiles/bundle/{}')
endif
...
" work properly when Vim is used. github.com/microsoft/terminal/issues/832
